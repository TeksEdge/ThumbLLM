...
| ------------------------------------------------- | -------------------------------------- | ------------ | ------- | ---------------- | ----------- | ----------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| ThumbLLM 0.1.0 — Spark-X2.5 4B CPU Edition    | XHToken/Spark-X2.5-4B-GGUF             | Q4_K_M       | CPU     | llama.cpp b10909 | Windows x64 | [Download](https://github.com/TeksEdge/ThumbLLM/releases)         | [View Recipe](recipes/Spark-X2.5-4B-Q4_K_M-CPU-Win-x64/README.md)             |
| ThumbLLM 0.1.0 — Qwen3.5 9B CPU Edition           | unsloth/Qwen3.5-9B-GGUF                | Q4_K_M       | CPU     | llama.cpp b10603 | Windows x64 | [Download](https://github.com/TeksEdge/ThumbLLM/releases)         | [View Recipe](recipes/Qwen3.5-9B-Q4_K_M-CPU-Win-x64/README.md)                |
