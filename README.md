...
| -------------------------------------------- | ------------------------------------- | ------------ | ------- | ---------------- | ----------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| **ThumbLLM 0.1.0 — MiniCPM5 2B CPU Edition** | openbmb/MiniCPM5-2B-GGUF              | Q4_K_M       | CPU     | llama.cpp b10603 | Windows x64 | [Download](https://github.com/TeksEdge/ThumbLLM/releases/tag/thumbllm-minicpm5-2b-q4_k_m-cpu-win-x64-v0.1.0)    | [View Recipe](recipes/MiniCPM5-2B-Q4_K_M-CPU-Win-x64/README.md)               |
